...
<head>
    ...
    <title>TRANG NÓN BẢO HIỂM 1/2</title>
...
<body>
   ...
   <div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=1'">
            <img src="../image/1.1.ĐEN.PNG" alt="Nón nữa đầu">
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=1">Nón sơn đen</a>
            </div>
        </div>

        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=2'">
            <img src="../image/1.2.TIM.PNG" alt="Nón sơn tím">
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=2">Nón sơn tím</a>
            </div>
        </div>

        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=3'">
            <img src="../image/1.3.MINO.PNG" alt="Nón sơn xanh">
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=3">Nón sơn xanh</a>
            </div>
        </div>
