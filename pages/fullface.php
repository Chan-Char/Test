...
<head>
    <meta charset="UTF-8">
    <title>TRANG NÓN BẢO HIỂM FULL FACE</title>
...
<body>
 ...
 <div style="text-align: center; margin: 20px;">
    ...
    <div class="container">
        ...
        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=41'">
            <img src="../image/4.1.PNG" alt="Nón fullface có họa tiết lửa đỏ">
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=41">Nón fullface có họa tiết lửa đỏ</a>
            </div>
        </div>

        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=42'">
            <img src="../image/4.2.PNG" alt="Nón fullface có họa tiết xám cam độc đáo">
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=42">Nón Fullface có họa tiết xám cam độc đáo</a>
            </div>
        </div>

        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=43'">
            <img src="../image/4.3.PNG" alt="Nón fullface đen">
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=43">Nón Fullface đen </a>
            </div>
        </div>
