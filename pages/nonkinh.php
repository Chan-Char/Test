 ...
 <div style="text-align: center; margin: 20px;">
    ...
    <div class="container">
        ...
        <div class="service-card" onclick="window.location.href='chitietnuadau.php?product_id=53'">
            ...
            <div class="service-name">
                <a href="chitietnuadau.php?product_id=53">Nón kính 3</a>
            </div>
        </div>
