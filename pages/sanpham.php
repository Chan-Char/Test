...
<body>
 ...
 <div style="text-align: center; margin: 20px;">
    ...
    <div class="container">
        <div class="service-card" onclick="window.location.href='nuadau.php'">
        ...
        <div class="service-card" onclick="window.location.href='nonbaphan.php'">
        ...
        <div class="service-card" onclick="window.location.href='fullface.php'">
        ...
        <div class="service-card" onclick="window.location.href='nonkinh.php'">
